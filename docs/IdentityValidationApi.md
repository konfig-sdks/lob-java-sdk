...
|------------- | ------------- | -------------|
| [**validation**](IdentityValidationApi.md#validation) | **POST** /identity_validation | Identity Validation |


<a name="validation"></a>
# **validation**
> Object validation(body).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling IdentityValidationApi#validation");
