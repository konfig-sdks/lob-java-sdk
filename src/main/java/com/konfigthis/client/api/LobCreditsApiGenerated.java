...
public class LobCreditsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LobCreditsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LobCreditsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
