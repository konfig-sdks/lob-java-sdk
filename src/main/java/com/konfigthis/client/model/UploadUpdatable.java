...
public class UploadUpdatable {
  ...
  **/
   ...
   * @return the UploadUpdatable instance itself
   */
  public UploadUpdatable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.originalFilename, uploadUpdatable.originalFilename) &&
        ...
        Objects.equals(this.additionalProperties, uploadUpdatable.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(originalFilename, requiredAddressColumnMapping, optionalAddressColumnMapping, metadata, mergeVariableColumnMapping, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadUpdatable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadUpdatable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UploadUpdatable>() {
           ...
           public UploadUpdatable read(JsonReader in) throws IOException {
             ...
             UploadUpdatable instance = thisAdapter.fromJsonTree(jsonObj);
