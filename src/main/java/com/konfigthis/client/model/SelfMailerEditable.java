...
public class SelfMailerEditable {
  ...
  **/
  ...
  public SelfMailerEditable mergeVariables(String mergeVariables) {
  ...
  **/
  ...
  public SelfMailerEditable sendDate(Object sendDate) {
  ...
  **/
  ...
  public SelfMailerEditable inside(Object inside) {
  ...
  **/
  ...
  public SelfMailerEditable outside(Object outside) {
  ...
  **/
  ...
  public SelfMailerEditable qrCode(QrCode qrCode) {
  ...
  **/
  ...
  public SelfMailerEditable fsc(Boolean fsc) {
  ...
  **/
   ...
   * @return the SelfMailerEditable instance itself
   */
  public SelfMailerEditable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, selfMailerEditable.description) &&
        ...
        Objects.equals(this.to, selfMailerEditable.to) &&
        ...
        Objects.equals(this.qrCode, selfMailerEditable.qrCode) &&
        Objects.equals(this.useType, selfMailerEditable.useType) &&
        Objects.equals(this.fsc, selfMailerEditable.fsc)&&
        Objects.equals(this.additionalProperties, selfMailerEditable.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, metadata, mailType, mergeVariables, sendDate, size, to, from, inside, outside, billingGroupId, qrCode, useType, fsc, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SelfMailerEditable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SelfMailerEditable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SelfMailerEditable is not found in the empty JSON string", SelfMailerEditable.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SelfMailerEditable.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelfMailerEditable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelfMailerEditable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelfMailerEditable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelfMailerEditable.class));

       return (TypeAdapter<T>) new TypeAdapter<SelfMailerEditable>() {
           @Override
           public void write(JsonWriter out, SelfMailerEditable value) throws IOException {
           ...
           @Override
           public SelfMailerEditable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SelfMailerEditable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SelfMailerEditable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelfMailerEditable
  * @throws IOException if the JSON string is invalid with respect to SelfMailerEditable
  */
  public static SelfMailerEditable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelfMailerEditable.class);
  }

 /**
  * Convert an instance of SelfMailerEditable to an JSON string
  *
  * @return JSON string
  */
