 ...
 */
@ApiModel(description = "Multiple items returned in order")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class List {
  ...
  public List _object(String _object) {
  ...
  **/
  ...
  public List nextUrl(String nextUrl) {
  ...
  **/
  ...
  public List previousUrl(String previousUrl) {
  ...
  **/
  ...
  public List count(Integer count) {
  ...
  **/
  ...
  public List totalCount(Integer totalCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    List list = (List) o;
    return Objects.equals(this._object, list._object) &&
        Objects.equals(this.nextUrl, list.nextUrl) &&
        Objects.equals(this.previousUrl, list.previousUrl) &&
        Objects.equals(this.count, list.count) &&
        Objects.equals(this.totalCount, list.totalCount)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_object, nextUrl, previousUrl, count, totalCount, additionalProperties);
  }
