...
public class UploadsMetadata {
  ...
  **/
  ...
  @ApiModelProperty(example = "[]", required = true, value = "The list of column names from the csv file which you want associated with each of your mailpieces")
   ...
   * @return the UploadsMetadata instance itself
   */
  public UploadsMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, uploadsMetadata.columns)&&
        Objects.equals(this.additionalProperties, uploadsMetadata.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadsMetadata
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UploadsMetadata>() {
           ...
           public UploadsMetadata read(JsonReader in) throws IOException {
             ...
             UploadsMetadata instance = thisAdapter.fromJsonTree(jsonObj);
