...
public class CompanyInput {
  ...
  **/
   ...
   * @return the CompanyInput instance itself
   */
  public CompanyInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.company, companyInput.company) &&
        ...
        Objects.equals(this.additionalProperties, companyInput.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CompanyInput>() {
           ...
           public CompanyInput read(JsonReader in) throws IOException {
             ...
             CompanyInput instance = thisAdapter.fromJsonTree(jsonObj);
