 ...
 */
@ApiModel(description = "A nested object containing a breakdown of the analysis of a reverse geocoded location.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LocationAnalysis {
  ...
  **/
   ...
   * @return the LocationAnalysis instance itself
   */
  public LocationAnalysis putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.latitude, locationAnalysis.latitude) &&
        ...
        Objects.equals(this.additionalProperties, locationAnalysis.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latitude, longitude, distance, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocationAnalysis
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocationAnalysis.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LocationAnalysis>() {
           ...
           public LocationAnalysis read(JsonReader in) throws IOException {
             ...
             LocationAnalysis instance = thisAdapter.fromJsonTree(jsonObj);
