...
public class UploadCreateExport {
  ...
  **/
  ...
  @ApiModelProperty(example = "EXPORT_IS_PROCESSING", required = true, value = "")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "ex_2dafd758ed3da9c43", required = true, value = "")
   ...
   * @return the UploadCreateExport instance itself
   */
  public UploadCreateExport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, uploadCreateExport.message) &&
        ...
        Objects.equals(this.additionalProperties, uploadCreateExport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, exportId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadCreateExport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadCreateExport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UploadCreateExport>() {
           ...
           public UploadCreateExport read(JsonReader in) throws IOException {
             ...
             UploadCreateExport instance = thisAdapter.fromJsonTree(jsonObj);
