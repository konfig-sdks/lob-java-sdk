...
public class ZipLookupCity {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "Indicates whether or not the city is the <a href=\"https://en.wikipedia.org/wiki/ZIP_Code#ZIP_Codes_and_previous_zoning_lines\" target=\"_blank\">USPS default city</a> (preferred city) of a ZIP code. There is only one preferred city per ZIP code, which will always be in position 0 in the array of cities. ")
   ...
   * @return the ZipLookupCity instance itself
   */
  public ZipLookupCity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.city, zipLookupCity.city) &&
        ...
        Objects.equals(this.additionalProperties, zipLookupCity.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(city, state, county, countyFips, preferred, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ZipLookupCity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ZipLookupCity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ZipLookupCity>() {
           ...
           public ZipLookupCity read(JsonReader in) throws IOException {
             ...
             ZipLookupCity instance = thisAdapter.fromJsonTree(jsonObj);
