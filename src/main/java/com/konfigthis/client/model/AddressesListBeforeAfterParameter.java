...
public class AddressesListBeforeAfterParameter {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "A reference to a list entry used for paginating to the previous set of entries. This field is pre-populated in the `previous_url` field in the return response. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A reference to a list entry used for paginating to the next set of entries. This field is pre-populated in the `next_url` field in the return response. ")
   ...
   * @return the AddressesListBeforeAfterParameter instance itself
   */
  public AddressesListBeforeAfterParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.before, addressesListBeforeAfterParameter.before) &&
        ...
        Objects.equals(this.additionalProperties, addressesListBeforeAfterParameter.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddressesListBeforeAfterParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddressesListBeforeAfterParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : AddressesListBeforeAfterParameter.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddressesListBeforeAfterParameter>() {
           ...
           public AddressesListBeforeAfterParameter read(JsonReader in) throws IOException {
             ...
             AddressesListBeforeAfterParameter instance = thisAdapter.fromJsonTree(jsonObj);
