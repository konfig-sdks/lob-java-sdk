...
public class MultipleComponentsAllOf {
  ...
  public MultipleComponentsAllOf() {
  }

  public MultipleComponentsAllOf recipient(String recipient) {
  ...
  **/
  ...
  public MultipleComponentsAllOf primaryLine(String primaryLine) {
  ...
  **/
  ...
  public MultipleComponentsAllOf secondaryLine(String secondaryLine) {
  ...
  **/
  ...
  public MultipleComponentsAllOf urbanization(String urbanization) {
  ...
  **/
  ...
  public MultipleComponentsAllOf city(String city) {
  ...
  **/
  ...
  public MultipleComponentsAllOf state(String state) {
  ...
  **/
  ...
  public MultipleComponentsAllOf zipCode(Object zipCode) {
  ...
  **/
   ...
   * @return the MultipleComponentsAllOf instance itself
   */
  public MultipleComponentsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MultipleComponentsAllOf multipleComponentsAllOf = (MultipleComponentsAllOf) o;
    return Objects.equals(this.recipient, multipleComponentsAllOf.recipient) &&
        Objects.equals(this.primaryLine, multipleComponentsAllOf.primaryLine) &&
        Objects.equals(this.secondaryLine, multipleComponentsAllOf.secondaryLine) &&
        Objects.equals(this.urbanization, multipleComponentsAllOf.urbanization) &&
        Objects.equals(this.city, multipleComponentsAllOf.city) &&
        Objects.equals(this.state, multipleComponentsAllOf.state) &&
        Objects.equals(this.zipCode, multipleComponentsAllOf.zipCode)&&
        Objects.equals(this.additionalProperties, multipleComponentsAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipient, primaryLine, secondaryLine, urbanization, city, state, zipCode, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipleComponentsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MultipleComponentsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MultipleComponentsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MultipleComponentsAllOf is not found in the empty JSON string", MultipleComponentsAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MultipleComponentsAllOf.openapiRequiredFields) {
      ...
      if (jsonObj.get("zip_code") != null && !jsonObj.get("zip_code").isJsonNull()) {
        Object.validateJsonObject(jsonObj.getAsJsonObject("zip_code"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultipleComponentsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultipleComponentsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultipleComponentsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultipleComponentsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MultipleComponentsAllOf>() {
           @Override
           public void write(JsonWriter out, MultipleComponentsAllOf value) throws IOException {
           ...
           @Override
           public MultipleComponentsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MultipleComponentsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MultipleComponentsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MultipleComponentsAllOf
  * @throws IOException if the JSON string is invalid with respect to MultipleComponentsAllOf
  */
  public static MultipleComponentsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultipleComponentsAllOf.class);
  }

 /**
  * Convert an instance of MultipleComponentsAllOf to an JSON string
  *
  * @return JSON string
  */
