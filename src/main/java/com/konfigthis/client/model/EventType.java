...
public class EventType {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Value is `true` if the event type is enabled in both the test and live environments and `false` if it is only enabled in the live environment.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "EVENT_TYPE", required = true, value = "Value is resource type.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, enabledForTest, resource, _object, additionalProperties);
  }
