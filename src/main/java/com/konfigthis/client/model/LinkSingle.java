...
public class LinkSingle {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The original target URL.")
  ...
  **/
  ...
  @ApiModelProperty(value = "The registered domain to be used for the short URL.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The unique path for the shortened URL, if empty a unique path will be used.")
  ...
  **/
   ...
   * @return the LinkSingle instance itself
   */
  public LinkSingle putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.redirectLink, linkSingle.redirectLink) &&
        ...
        Objects.equals(this.additionalProperties, linkSingle.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(redirectLink, domain, slug, metadataTag, billingGroupId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkSingle
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkSingle.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LinkSingle>() {
           ...
           public LinkSingle read(JsonReader in) throws IOException {
             ...
             LinkSingle instance = thisAdapter.fromJsonTree(jsonObj);
