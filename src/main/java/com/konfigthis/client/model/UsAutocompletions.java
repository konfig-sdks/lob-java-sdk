...
public class UsAutocompletions {
  ...
  **/
  ...
  @ApiModelProperty(value = "Unique identifier prefixed with `us_auto_`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "US_AUTOCOMPLETION", value = "Value is resource type.")
   ...
   * @return the UsAutocompletions instance itself
   */
  public UsAutocompletions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, usAutocompletions.id) &&
        ...
        Objects.equals(this.additionalProperties, usAutocompletions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, suggestions, _object, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsAutocompletions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsAutocompletions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("suggestions") != null && !jsonObj.get("suggestions").isJsonNull()) {
        ...
        if (jsonArraysuggestions != null) {
          ...
          for (int i = 0; i < jsonArraysuggestions.size(); i++) {
            Suggestions.validateJsonObject(jsonArraysuggestions.get(i).getAsJsonObject());
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UsAutocompletions>() {
           ...
           public UsAutocompletions read(JsonReader in) throws IOException {
             ...
             UsAutocompletions instance = thisAdapter.fromJsonTree(jsonObj);
