...
public class From {
  ...
  **/
   ...
   * @return the From instance itself
   */
  public From putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.from, from.from)&&
        Objects.equals(this.additionalProperties, from.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<From>() {
           ...
           public From read(JsonReader in) throws IOException {
             ...
             From instance = thisAdapter.fromJsonTree(jsonObj);
