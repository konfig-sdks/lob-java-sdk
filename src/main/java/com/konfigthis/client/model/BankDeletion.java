...
public class BankDeletion {
  ...
  **/
   ...
   * @return the BankDeletion instance itself
   */
  public BankDeletion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, bankDeletion.id) &&
        ...
        Objects.equals(this.additionalProperties, bankDeletion.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BankDeletion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BankDeletion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BankDeletion>() {
           ...
           public BankDeletion read(JsonReader in) throws IOException {
             ...
             BankDeletion instance = thisAdapter.fromJsonTree(jsonObj);
