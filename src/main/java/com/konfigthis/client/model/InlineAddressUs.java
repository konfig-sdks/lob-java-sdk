...
public class InlineAddressUs {
  ...
  public InlineAddressUs addressLine1(String addressLine1) {
  ...
  **/
  ...
  public InlineAddressUs addressLine2(String addressLine2) {
  ...
  **/
  ...
  public InlineAddressUs addressCity(String addressCity) {
  ...
  **/
  ...
  public InlineAddressUs addressState(String addressState) {
  ...
  **/
  ...
  public InlineAddressUs addressZip(String addressZip) {
  ...
  **/
   ...
   * @return the InlineAddressUs instance itself
   */
  public InlineAddressUs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InlineAddressUs inlineAddressUs = (InlineAddressUs) o;
    return Objects.equals(this.addressLine1, inlineAddressUs.addressLine1) &&
        Objects.equals(this.addressLine2, inlineAddressUs.addressLine2) &&
        Objects.equals(this.addressCity, inlineAddressUs.addressCity) &&
        Objects.equals(this.addressState, inlineAddressUs.addressState) &&
        Objects.equals(this.addressZip, inlineAddressUs.addressZip)&&
        Objects.equals(this.additionalProperties, inlineAddressUs.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineAddressUs {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InlineAddressUs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InlineAddressUs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InlineAddressUs is not found in the empty JSON string", InlineAddressUs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InlineAddressUs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InlineAddressUs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InlineAddressUs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InlineAddressUs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InlineAddressUs.class));

       return (TypeAdapter<T>) new TypeAdapter<InlineAddressUs>() {
           @Override
           public void write(JsonWriter out, InlineAddressUs value) throws IOException {
           ...
           @Override
           public InlineAddressUs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InlineAddressUs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InlineAddressUs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InlineAddressUs
  * @throws IOException if the JSON string is invalid with respect to InlineAddressUs
  */
  public static InlineAddressUs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InlineAddressUs.class);
  }

 /**
  * Convert an instance of InlineAddressUs to an JSON string
  *
  * @return JSON string
  */
