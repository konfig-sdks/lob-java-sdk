...
public class CardDeletion {
  ...
  **/
   ...
   * @return the CardDeletion instance itself
   */
  public CardDeletion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, cardDeletion.id) &&
        ...
        Objects.equals(this.additionalProperties, cardDeletion.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardDeletion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardDeletion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CardDeletion>() {
           ...
           public CardDeletion read(JsonReader in) throws IOException {
             ...
             CardDeletion instance = thisAdapter.fromJsonTree(jsonObj);
