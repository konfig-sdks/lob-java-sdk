...
public class IntlVerification {
  ...
  **/
   ...
   * @return the IntlVerification instance itself
   */
  public IntlVerification putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.recipient, intlVerification.recipient) &&
        ...
        Objects.equals(this.additionalProperties, intlVerification.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipient, primaryLine, secondaryLine, components, id, lastLine, country, coverage, deliverability, status, _object, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to IntlVerification
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IntlVerification.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntlVerification>() {
           ...
           public IntlVerification read(JsonReader in) throws IOException {
             ...
             IntlVerification instance = thisAdapter.fromJsonTree(jsonObj);
