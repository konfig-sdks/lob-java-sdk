...
public class Domains {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The registered domain/hostname.")
   ...
   * @return the Domains instance itself
   */
  public Domains putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, domains.domain)&&
        Objects.equals(this.additionalProperties, domains.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Domains>() {
           ...
           public Domains read(JsonReader in) throws IOException {
             ...
             Domains instance = thisAdapter.fromJsonTree(jsonObj);
