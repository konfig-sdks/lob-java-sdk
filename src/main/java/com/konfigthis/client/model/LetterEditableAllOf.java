...
public class LetterEditableAllOf {
  ...
  public LetterEditableAllOf() {
  }

  public LetterEditableAllOf _file(Object _file) {
  ...
  **/
  ...
  public LetterEditableAllOf extraService(ExtraService extraService) {
  ...
  **/
  ...
  public LetterEditableAllOf cards(List<String> cards) {
  ...
  public LetterEditableAllOf addCardsItem(String cardsItem) {
    if (this.cards == null) {
  ...
  **/
  ...
  public LetterEditableAllOf mailType(MailType mailType) {
  ...
  **/
  ...
  public LetterEditableAllOf color(Boolean color) {
  ...
  **/
  ...
  public LetterEditableAllOf doubleSided(Boolean doubleSided) {
  ...
  **/
  ...
  public LetterEditableAllOf addressPlacement(AddressPlacement addressPlacement) {
  ...
  **/
  ...
  public LetterEditableAllOf returnEnvelope(Object returnEnvelope) {
  ...
  **/
  ...
  public LetterEditableAllOf perforatedPage(Integer perforatedPage) {
  ...
  **/
  ...
  public LetterEditableAllOf customEnvelope(String customEnvelope) {
  ...
  **/
  ...
  public LetterEditableAllOf billingGroupId(String billingGroupId) {
  ...
  **/
  ...
  public LetterEditableAllOf qrCode(QrCode qrCode) {
  ...
  **/
  ...
  public LetterEditableAllOf useType(LtrUseType useType) {
  ...
  **/
  ...
  public LetterEditableAllOf fsc(Boolean fsc) {
  ...
  **/
  ...
  public LetterEditableAllOf size(LtrSize size) {
  ...
  **/
   ...
   * @return the LetterEditableAllOf instance itself
   */
  public LetterEditableAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LetterEditableAllOf letterEditableAllOf = (LetterEditableAllOf) o;
    return Objects.equals(this._file, letterEditableAllOf._file) &&
        Objects.equals(this.extraService, letterEditableAllOf.extraService) &&
        Objects.equals(this.cards, letterEditableAllOf.cards) &&
        Objects.equals(this.mailType, letterEditableAllOf.mailType) &&
        Objects.equals(this.color, letterEditableAllOf.color) &&
        Objects.equals(this.doubleSided, letterEditableAllOf.doubleSided) &&
        Objects.equals(this.addressPlacement, letterEditableAllOf.addressPlacement) &&
        Objects.equals(this.returnEnvelope, letterEditableAllOf.returnEnvelope) &&
        Objects.equals(this.perforatedPage, letterEditableAllOf.perforatedPage) &&
        Objects.equals(this.customEnvelope, letterEditableAllOf.customEnvelope) &&
        Objects.equals(this.billingGroupId, letterEditableAllOf.billingGroupId) &&
        Objects.equals(this.qrCode, letterEditableAllOf.qrCode) &&
        Objects.equals(this.useType, letterEditableAllOf.useType) &&
        Objects.equals(this.fsc, letterEditableAllOf.fsc) &&
        Objects.equals(this.size, letterEditableAllOf.size)&&
        Objects.equals(this.additionalProperties, letterEditableAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_file, extraService, cards, mailType, color, doubleSided, addressPlacement, returnEnvelope, perforatedPage, customEnvelope, billingGroupId, qrCode, useType, fsc, size, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LetterEditableAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LetterEditableAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LetterEditableAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LetterEditableAllOf is not found in the empty JSON string", LetterEditableAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LetterEditableAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LetterEditableAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LetterEditableAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LetterEditableAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LetterEditableAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<LetterEditableAllOf>() {
           @Override
           public void write(JsonWriter out, LetterEditableAllOf value) throws IOException {
           ...
           @Override
           public LetterEditableAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LetterEditableAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LetterEditableAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LetterEditableAllOf
  * @throws IOException if the JSON string is invalid with respect to LetterEditableAllOf
  */
  public static LetterEditableAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LetterEditableAllOf.class);
  }

 /**
  * Convert an instance of LetterEditableAllOf to an JSON string
  *
  * @return JSON string
  */
