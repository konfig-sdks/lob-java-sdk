...
public class SelfMailer {
  ...
  **/
  ...
  public SelfMailer sendDate(Object sendDate) {
  ...
  **/
  ...
  public SelfMailer status(Status status) {
  ...
  **/
  ...
  public SelfMailer campaignId(String campaignId) {
  ...
  **/
  ...
  public SelfMailer failureReason(FailureReason failureReason) {
  ...
  **/
   ...
   * @return the SelfMailer instance itself
   */
  public SelfMailer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, selfMailer.description) &&
        ...
        Objects.equals(this.campaignId, selfMailer.campaignId) &&
        Objects.equals(this.failureReason, selfMailer.failureReason)&&
        Objects.equals(this.additionalProperties, selfMailer.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, metadata, mailType, mergeVariables, sendDate, size, to, carrier, thumbnails, expectedDeliveryDate, dateCreated, dateModified, deleted, from, id, outsideTemplateId, insideTemplateId, outsideTemplateVersionId, insideTemplateVersionId, _object, trackingEvents, useType, url, fsc, status, campaignId, failureReason, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SelfMailer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SelfMailer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SelfMailer>() {
           ...
           public SelfMailer read(JsonReader in) throws IOException {
             ...
             SelfMailer instance = thisAdapter.fromJsonTree(jsonObj);
