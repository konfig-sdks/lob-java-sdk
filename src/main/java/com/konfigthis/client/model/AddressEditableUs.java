...
public class AddressEditableUs {
  ...
  public AddressEditableUs addressLine1(String addressLine1) {
  ...
  **/
  ...
  public AddressEditableUs addressLine2(String addressLine2) {
  ...
  **/
  ...
  public AddressEditableUs addressCity(String addressCity) {
  ...
  **/
  ...
  public AddressEditableUs addressState(String addressState) {
  ...
  **/
  ...
  public AddressEditableUs addressZip(String addressZip) {
  ...
  **/
   ...
   * @return the AddressEditableUs instance itself
   */
  public AddressEditableUs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddressEditableUs addressEditableUs = (AddressEditableUs) o;
    return Objects.equals(this.addressLine1, addressEditableUs.addressLine1) &&
        Objects.equals(this.addressLine2, addressEditableUs.addressLine2) &&
        Objects.equals(this.addressCity, addressEditableUs.addressCity) &&
        Objects.equals(this.addressState, addressEditableUs.addressState) &&
        Objects.equals(this.addressZip, addressEditableUs.addressZip)&&
        Objects.equals(this.additionalProperties, addressEditableUs.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddressEditableUs {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddressEditableUs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddressEditableUs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressEditableUs is not found in the empty JSON string", AddressEditableUs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddressEditableUs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressEditableUs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressEditableUs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressEditableUs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressEditableUs.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressEditableUs>() {
           @Override
           public void write(JsonWriter out, AddressEditableUs value) throws IOException {
           ...
           @Override
           public AddressEditableUs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddressEditableUs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddressEditableUs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddressEditableUs
  * @throws IOException if the JSON string is invalid with respect to AddressEditableUs
  */
  public static AddressEditableUs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressEditableUs.class);
  }

 /**
  * Convert an instance of AddressEditableUs to an JSON string
  *
  * @return JSON string
  */
