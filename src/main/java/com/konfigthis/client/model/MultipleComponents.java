...
public class MultipleComponents {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The <a href=\"https://en.wikipedia.org/wiki/ISO_3166-2:US\" target=\"_blank\">ISO 3166-2</a> two letter code or subdivision name for the state. `city` and `state` are required if no `zip_code` is passed.")
  ...
  public MultipleComponents zipCode(Object zipCode) {
  ...
  **/
   ...
   * @return the MultipleComponents instance itself
   */
  public MultipleComponents putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.recipient, multipleComponents.recipient) &&
        ...
        Objects.equals(this.additionalProperties, multipleComponents.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MultipleComponents
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MultipleComponents.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MultipleComponents is not found in the empty JSON string", MultipleComponents.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MultipleComponents.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MultipleComponents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MultipleComponents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MultipleComponents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MultipleComponents.class));

       return (TypeAdapter<T>) new TypeAdapter<MultipleComponents>() {
           @Override
           public void write(JsonWriter out, MultipleComponents value) throws IOException {
           ...
           @Override
           public MultipleComponents read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MultipleComponents instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MultipleComponents given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MultipleComponents
  * @throws IOException if the JSON string is invalid with respect to MultipleComponents
  */
  public static MultipleComponents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MultipleComponents.class);
  }

 /**
  * Convert an instance of MultipleComponents to an JSON string
  *
  * @return JSON string
  */
