...
import com.konfigthis.client.model.Components;
import com.konfigthis.client.model.LocationAnalysis;
...
public class Addresses {
  ...
  **/
   ...
   * @return the Addresses instance itself
   */
  public Addresses putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.components, addresses.components) &&
        ...
        Objects.equals(this.additionalProperties, addresses.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(components, locationAnalysis, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Addresses
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Addresses.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("components") != null && !jsonObj.get("components").isJsonNull()) {
        Components.validateJsonObject(jsonObj.getAsJsonObject("components"));
      }
      ...
      if (jsonObj.get("location_analysis") != null && !jsonObj.get("location_analysis").isJsonNull()) {
        LocationAnalysis.validateJsonObject(jsonObj.getAsJsonObject("location_analysis"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Addresses>() {
           ...
           public Addresses read(JsonReader in) throws IOException {
             ...
             Addresses instance = thisAdapter.fromJsonTree(jsonObj);
