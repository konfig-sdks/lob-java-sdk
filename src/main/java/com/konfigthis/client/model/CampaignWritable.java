...
public class CampaignWritable {
  ...
  **/
   ...
   * @return the CampaignWritable instance itself
   */
  public CampaignWritable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, campaignWritable.description) &&
        Objects.equals(this.billingGroupId, campaignWritable.billingGroupId) &&
        ...
        Objects.equals(this.additionalProperties, campaignWritable.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, billingGroupId, name, scheduleType, targetDeliveryDate, sendDate, cancelWindowCampaignMinutes, metadata, useType, autoCancelIfNcoa, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignWritable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignWritable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CampaignWritable>() {
           ...
           public CampaignWritable read(JsonReader in) throws IOException {
             ...
             CampaignWritable instance = thisAdapter.fromJsonTree(jsonObj);
