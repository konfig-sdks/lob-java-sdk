...
public class OptionalAddressColumnMapping {
  ...
  **/
   ...
   * @return the OptionalAddressColumnMapping instance itself
   */
  public OptionalAddressColumnMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressLine2, optionalAddressColumnMapping.addressLine2) &&
        ...
        Objects.equals(this.additionalProperties, optionalAddressColumnMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressLine2, company, addressCountry, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OptionalAddressColumnMapping
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OptionalAddressColumnMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("address_line2").isJsonNull() && !jsonObj.get("address_line2").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("address_country").isJsonNull() && !jsonObj.get("address_country").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OptionalAddressColumnMapping>() {
           ...
           public OptionalAddressColumnMapping read(JsonReader in) throws IOException {
             ...
             OptionalAddressColumnMapping instance = thisAdapter.fromJsonTree(jsonObj);
