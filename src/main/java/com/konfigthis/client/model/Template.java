...
import com.konfigthis.client.model.TemplatePublishedVersion;
...
public class Template {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Unique identifier prefixed with `tmpl_`. ID of a saved [HTML template](#section/HTML-Templates).")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "An array of all non-deleted [version objects](#tag/Template-Versions) associated with the template.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "TEMPLATE", value = "Value is resource type.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, id, versions, publishedVersion, _object, metadata, dateCreated, dateModified, deleted, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (int i = 0; i < jsonArrayversions.size(); i++) {
        TemplateVersion.validateJsonObject(jsonArrayversions.get(i).getAsJsonObject());
      };
      // validate the required field `published_version`
      TemplatePublishedVersion.validateJsonObject(jsonObj.getAsJsonObject("published_version"));
