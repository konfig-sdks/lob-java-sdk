...
public class CardOrder {
  ...
  **/
  ...
  public CardOrder inventory(Double inventory) {
  ...
  public CardOrder inventory(Integer inventory) {
  ...
  **/
  ...
  public CardOrder quantityOrdered(Double quantityOrdered) {
  ...
  public CardOrder quantityOrdered(Integer quantityOrdered) {
  ...
  **/
  ...
  public CardOrder unitPrice(Double unitPrice) {
  ...
  public CardOrder unitPrice(Integer unitPrice) {
  ...
  **/
   ...
   * @return the CardOrder instance itself
   */
  public CardOrder putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dateCreated, cardOrder.dateCreated) &&
        ...
        Objects.equals(this.additionalProperties, cardOrder.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dateCreated, dateModified, deleted, _object, id, cardId, status, inventory, quantityOrdered, unitPrice, cancelledReason, availabilityDate, expectedAvailabilityDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardOrder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardOrder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CardOrder>() {
           ...
           public CardOrder read(JsonReader in) throws IOException {
             ...
             CardOrder instance = thisAdapter.fromJsonTree(jsonObj);
