...
public class RequiredAddressColumnMapping {
  ...
  **/
   ...
   * @return the RequiredAddressColumnMapping instance itself
   */
  public RequiredAddressColumnMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, requiredAddressColumnMapping.name) &&
        ...
        Objects.equals(this.additionalProperties, requiredAddressColumnMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, addressLine1, addressCity, addressState, addressZip, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RequiredAddressColumnMapping
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RequiredAddressColumnMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (!jsonObj.get("address_line1").isJsonNull() && !jsonObj.get("address_line1").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("address_city").isJsonNull() && !jsonObj.get("address_city").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("address_state").isJsonNull() && !jsonObj.get("address_state").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("address_zip").isJsonNull() && !jsonObj.get("address_zip").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RequiredAddressColumnMapping>() {
           ...
           public RequiredAddressColumnMapping read(JsonReader in) throws IOException {
             ...
             RequiredAddressColumnMapping instance = thisAdapter.fromJsonTree(jsonObj);
