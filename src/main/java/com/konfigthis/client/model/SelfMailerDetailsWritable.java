...
public class SelfMailerDetailsWritable {
  ...
  **/
   ...
   * @return the SelfMailerDetailsWritable instance itself
   */
  public SelfMailerDetailsWritable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mailType, selfMailerDetailsWritable.mailType) &&
        ...
        Objects.equals(this.additionalProperties, selfMailerDetailsWritable.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SelfMailerDetailsWritable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SelfMailerDetailsWritable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SelfMailerDetailsWritable>() {
           ...
           public SelfMailerDetailsWritable read(JsonReader in) throws IOException {
             ...
             SelfMailerDetailsWritable instance = thisAdapter.fromJsonTree(jsonObj);
