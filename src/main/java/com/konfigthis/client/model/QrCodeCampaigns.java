 ...
 */
@ApiModel(description = "Customize and place a QR code on all the postcards, letters or self mailers in a campaign. Redirect URLs can either be unique for each recipient, or a single link can be used for the whole campaign. See `redirect_url` attribute below for more details.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class QrCodeCampaigns {
  ...
  **/
  ...
  public QrCodeCampaigns redirectUrl(Object redirectUrl) {
  ...
  **/
   ...
   * @return the QrCodeCampaigns instance itself
   */
  public QrCodeCampaigns putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.position, qrCodeCampaigns.position) &&
        ...
        Objects.equals(this.additionalProperties, qrCodeCampaigns.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to QrCodeCampaigns
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!QrCodeCampaigns.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QrCodeCampaigns>() {
           ...
           public QrCodeCampaigns read(JsonReader in) throws IOException {
             ...
             QrCodeCampaigns instance = thisAdapter.fromJsonTree(jsonObj);
