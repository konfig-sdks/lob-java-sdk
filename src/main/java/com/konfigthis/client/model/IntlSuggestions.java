...
public class IntlSuggestions {
  ...
  **/
   ...
   * @return the IntlSuggestions instance itself
   */
  public IntlSuggestions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.primaryNumberRange, intlSuggestions.primaryNumberRange) &&
        ...
        Objects.equals(this.additionalProperties, intlSuggestions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(primaryNumberRange, primaryLine, city, country, state, zipCode, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to IntlSuggestions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IntlSuggestions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntlSuggestions>() {
           ...
           public IntlSuggestions read(JsonReader in) throws IOException {
             ...
             IntlSuggestions instance = thisAdapter.fromJsonTree(jsonObj);
