...
public class Editable {
  ...
  **/
  ...
  public Editable sendDate(Object sendDate) {
  ...
  **/
   ...
   * @return the Editable instance itself
   */
  public Editable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, editable.description) &&
        ...
        Objects.equals(this.additionalProperties, editable.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, metadata, mailType, mergeVariables, sendDate, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Editable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Editable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Editable>() {
           ...
           public Editable read(JsonReader in) throws IOException {
             ...
             Editable instance = thisAdapter.fromJsonTree(jsonObj);
