...
public class Registered {
  ...
  /**
   * Add an extra service to your letter. See &lt;a href&#x3D;\&quot;https://www.lob.com/pricing/print-mail#compare\&quot; target&#x3D;\&quot;_blank\&quot;&gt;pricing&lt;/a&gt; for extra costs incurred.   * registered - provides tracking and confirmation for international addresses 
   */
 ...
 public enum ObjectEnum {
  ...
  public Registered description(String description) {
  ...
  **/
  ...
  public Registered extraService(ExtraServiceEnum extraService) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Add an extra service to your letter. See <a href=\"https://www.lob.com/pricing/print-mail#compare\" target=\"_blank\">pricing</a> for extra costs incurred.   * registered - provides tracking and confirmation for international addresses ")
  ...
  public Registered trackingNumber(String trackingNumber) {
   ...
   /**
   * The tracking number will appear here when it becomes available. Dummy tracking numbers are not created in test mode.
   * @return trackingNumber
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The tracking number will appear here when it becomes available. Dummy tracking numbers are not created in test mode.")
  ...
  public Registered trackingEvents(List<TrackingEventNormal> trackingEvents) {
  ...
  public Registered addTrackingEventsItem(TrackingEventNormal trackingEventsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Tracking events are not populated for registered letters.")
  ...
  public Registered returnAddress(Object returnAddress) {
  ...
  **/
  ...
  public Registered metadata(Map<String, String> metadata) {
  ...
  public Registered putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public Registered mergeVariables(String mergeVariables) {
  ...
  **/
  ...
  public Registered sendDate(Object sendDate) {
  ...
  **/
  ...
  public Registered mailType(MailType mailType) {
  ...
  **/
  ...
  public Registered color(Boolean color) {
  ...
  **/
  ...
  public Registered doubleSided(Boolean doubleSided) {
  ...
  **/
  ...
  public Registered addressPlacement(AddressPlacement addressPlacement) {
  ...
  **/
  ...
  public Registered returnEnvelope(Object returnEnvelope) {
  ...
  **/
  ...
  public Registered perforatedPage(Integer perforatedPage) {
  ...
  **/
  ...
  public Registered customEnvelope(CustomEnvelopeReturned customEnvelope) {
  ...
  **/
  ...
  public Registered to(Object to) {
  ...
  **/
  ...
  public Registered carrier(CarrierEnum carrier) {
  ...
  **/
  ...
  public Registered thumbnails(List<Thumbnail> thumbnails) {
  ...
  public Registered addThumbnailsItem(Thumbnail thumbnailsItem) {
  ...
  **/
  ...
  public Registered expectedDeliveryDate(LocalDate expectedDeliveryDate) {
  ...
  **/
  ...
  public Registered dateCreated(OffsetDateTime dateCreated) {
  ...
  **/
  ...
  public Registered dateModified(OffsetDateTime dateModified) {
  ...
  **/
  ...
  public Registered deleted(Boolean deleted) {
  ...
  **/
  ...
  public Registered from(Object from) {
  ...
  **/
  ...
  public Registered url(String url) {
  ...
  **/
  ...
  public Registered id(String id) {
  ...
  **/
  ...
  public Registered templateId(Object templateId) {
  ...
  **/
  ...
  public Registered templateVersionId(String templateVersionId) {
  ...
  **/
  ...
  public Registered campaignId(String campaignId) {
  ...
  **/
  ...
  public Registered useType(LtrUseType useType) {
  ...
  **/
  ...
  public Registered fsc(Boolean fsc) {
  ...
  **/
  ...
  public Registered status(Status status) {
  ...
  **/
  ...
  public Registered failureReason(FailureReason failureReason) {
  ...
  **/
  ...
  public Registered _object(ObjectEnum _object) {
  ...
  **/
   ...
   * @return the Registered instance itself
   */
  public Registered putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, registered.description) &&
        Objects.equals(this.extraService, registered.extraService) &&
        Objects.equals(this.trackingNumber, registered.trackingNumber) &&
        Objects.equals(this.trackingEvents, registered.trackingEvents) &&
        Objects.equals(this.returnAddress, registered.returnAddress) &&
        Objects.equals(this.metadata, registered.metadata) &&
        Objects.equals(this.mergeVariables, registered.mergeVariables) &&
        Objects.equals(this.sendDate, registered.sendDate) &&
        Objects.equals(this.mailType, registered.mailType) &&
        Objects.equals(this.color, registered.color) &&
        Objects.equals(this.doubleSided, registered.doubleSided) &&
        Objects.equals(this.addressPlacement, registered.addressPlacement) &&
        Objects.equals(this.returnEnvelope, registered.returnEnvelope) &&
        Objects.equals(this.perforatedPage, registered.perforatedPage) &&
        Objects.equals(this.customEnvelope, registered.customEnvelope) &&
        Objects.equals(this.to, registered.to) &&
        Objects.equals(this.carrier, registered.carrier) &&
        Objects.equals(this.thumbnails, registered.thumbnails) &&
        Objects.equals(this.expectedDeliveryDate, registered.expectedDeliveryDate) &&
        Objects.equals(this.dateCreated, registered.dateCreated) &&
        Objects.equals(this.dateModified, registered.dateModified) &&
        Objects.equals(this.deleted, registered.deleted) &&
        Objects.equals(this.from, registered.from) &&
        Objects.equals(this.url, registered.url) &&
        Objects.equals(this.id, registered.id) &&
        Objects.equals(this.templateId, registered.templateId) &&
        Objects.equals(this.templateVersionId, registered.templateVersionId) &&
        Objects.equals(this.campaignId, registered.campaignId) &&
        Objects.equals(this.useType, registered.useType) &&
        Objects.equals(this.fsc, registered.fsc) &&
        Objects.equals(this.status, registered.status) &&
        Objects.equals(this.failureReason, registered.failureReason) &&
        Objects.equals(this._object, registered._object)&&
        Objects.equals(this.additionalProperties, registered.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Registered
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Registered.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Registered is not found in the empty JSON string", Registered.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Registered.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Registered.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Registered' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Registered> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Registered.class));

       return (TypeAdapter<T>) new TypeAdapter<Registered>() {
           @Override
           public void write(JsonWriter out, Registered value) throws IOException {
           ...
           @Override
           public Registered read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Registered instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Registered given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Registered
  * @throws IOException if the JSON string is invalid with respect to Registered
  */
  public static Registered fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Registered.class);
  }

 /**
  * Convert an instance of Registered to an JSON string
  *
  * @return JSON string
  */
