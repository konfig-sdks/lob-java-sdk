...
public class TrackingEventCertified {
  ...
  **/
   ...
   * @return the TrackingEventCertified instance itself
   */
  public TrackingEventCertified putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, trackingEventCertified.id) &&
        ...
        Objects.equals(this.additionalProperties, trackingEventCertified.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TrackingEventCertified
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TrackingEventCertified.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TrackingEventCertified>() {
           ...
           public TrackingEventCertified read(JsonReader in) throws IOException {
             ...
             TrackingEventCertified instance = thisAdapter.fromJsonTree(jsonObj);
