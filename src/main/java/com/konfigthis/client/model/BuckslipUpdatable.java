...
public class BuckslipUpdatable {
  ...
  **/
  ...
  public BuckslipUpdatable reorderQuantity(Double reorderQuantity) {
    if (reorderQuantity != null && reorderQuantity < 5000) {
      throw new IllegalArgumentException("Invalid value for reorderQuantity. Must be greater than or equal to 5000.");
    }
    if (reorderQuantity != null && reorderQuantity > 10000000) {
      throw new IllegalArgumentException("Invalid value for reorderQuantity. Must be less than or equal to 10000000.");
    }
  ...
  public BuckslipUpdatable reorderQuantity(Integer reorderQuantity) {
    if (reorderQuantity != null && reorderQuantity < 5000) {
      throw new IllegalArgumentException("Invalid value for reorderQuantity. Must be greater than or equal to 5000.");
    }
    if (reorderQuantity != null && reorderQuantity > 10000000) {
    ...
    this.reorderQuantity = reorderQuantity.doubleValue();
    return this;
  }
  ...
  **/
   ...
   * @return the BuckslipUpdatable instance itself
   */
  public BuckslipUpdatable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, buckslipUpdatable.description) &&
        ...
        Objects.equals(this.additionalProperties, buckslipUpdatable.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, autoReorder, reorderQuantity, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BuckslipUpdatable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BuckslipUpdatable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BuckslipUpdatable>() {
           ...
           public BuckslipUpdatable read(JsonReader in) throws IOException {
             ...
             BuckslipUpdatable instance = thisAdapter.fromJsonTree(jsonObj);
