 ...
 */
@ApiModel(description = "Lob Confidence Score is a nested object that provides a numerical value between 0-100 of the likelihood that an address is deliverable based on Lob’s mail delivery data to over half of US households.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LobConfidenceScore {
  ...
  **/
   ...
   * @return the LobConfidenceScore instance itself
   */
  public LobConfidenceScore putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.score, lobConfidenceScore.score) &&
        ...
        Objects.equals(this.additionalProperties, lobConfidenceScore.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, level, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LobConfidenceScore
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LobConfidenceScore.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LobConfidenceScore>() {
           ...
           public LobConfidenceScore read(JsonReader in) throws IOException {
             ...
             LobConfidenceScore instance = thisAdapter.fromJsonTree(jsonObj);
