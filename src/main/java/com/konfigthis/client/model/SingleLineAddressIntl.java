...
public class SingleLineAddressIntl {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The entire address in one string (e.g., \"370 Water St C1N 1C4\"). ")
  ...
  **/
   ...
   * @return the SingleLineAddressIntl instance itself
   */
  public SingleLineAddressIntl putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, singleLineAddressIntl.address) &&
        ...
        Objects.equals(this.additionalProperties, singleLineAddressIntl.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, country, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SingleLineAddressIntl
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SingleLineAddressIntl.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SingleLineAddressIntl>() {
           ...
           public SingleLineAddressIntl read(JsonReader in) throws IOException {
             ...
             SingleLineAddressIntl instance = thisAdapter.fromJsonTree(jsonObj);
