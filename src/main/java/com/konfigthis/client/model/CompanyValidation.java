...
public class CompanyValidation {
 ...
 public enum ObjectEnum {
  ...
  public CompanyValidation id(String id) {
  ...
  **/
  ...
  public CompanyValidation company(String company) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the company or firm.")
  ...
  public CompanyValidation primaryLine(String primaryLine) {
  ...
  **/
  ...
  public CompanyValidation secondaryLine(String secondaryLine) {
  ...
  **/
  ...
  public CompanyValidation urbanization(String urbanization) {
  ...
  **/
  ...
  public CompanyValidation lastLine(String lastLine) {
  ...
  **/
  ...
  public CompanyValidation score(Float score) {
  ...
  **/
  ...
  public CompanyValidation confidence(ConfidenceEnum confidence) {
  ...
  **/
  ...
  public CompanyValidation _object(ObjectEnum _object) {
  ...
  **/
   ...
   * @return the CompanyValidation instance itself
   */
  public CompanyValidation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyValidation companyValidation = (CompanyValidation) o;
    return Objects.equals(this.id, companyValidation.id) &&
        Objects.equals(this.company, companyValidation.company) &&
        Objects.equals(this.primaryLine, companyValidation.primaryLine) &&
        Objects.equals(this.secondaryLine, companyValidation.secondaryLine) &&
        Objects.equals(this.urbanization, companyValidation.urbanization) &&
        Objects.equals(this.lastLine, companyValidation.lastLine) &&
        Objects.equals(this.score, companyValidation.score) &&
        Objects.equals(this.confidence, companyValidation.confidence) &&
        Objects.equals(this._object, companyValidation._object)&&
        Objects.equals(this.additionalProperties, companyValidation.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, company, primaryLine, secondaryLine, urbanization, lastLine, score, confidence, _object, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyValidation {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CompanyValidation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CompanyValidation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CompanyValidation is not found in the empty JSON string", CompanyValidation.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyValidation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyValidation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyValidation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyValidation.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyValidation>() {
           @Override
           public void write(JsonWriter out, CompanyValidation value) throws IOException {
           ...
           @Override
           public CompanyValidation read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CompanyValidation instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CompanyValidation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CompanyValidation
  * @throws IOException if the JSON string is invalid with respect to CompanyValidation
  */
  public static CompanyValidation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyValidation.class);
  }

 /**
  * Convert an instance of CompanyValidation to an JSON string
  *
  * @return JSON string
  */
