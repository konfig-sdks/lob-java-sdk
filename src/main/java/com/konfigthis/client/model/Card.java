...
public class Card {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "Description of the card.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dateCreated, dateModified, deleted, _object, description, size, id, url, autoReorder, reorderQuantity, rawUrl, frontOriginalUrl, backOriginalUrl, thumbnails, availableQuantity, pendingQuantity, status, orientation, thresholdAmount, additionalProperties);
  }
