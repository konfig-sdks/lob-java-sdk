...
public class RecipientInputAllOf {
  ...
  public RecipientInputAllOf() {
  }

  public RecipientInputAllOf recipient(String recipient) {
  ...
  **/
  ...
  public RecipientInputAllOf primaryLine(String primaryLine) {
  ...
  **/
  ...
  public RecipientInputAllOf secondaryLine(String secondaryLine) {
  ...
  **/
  ...
  public RecipientInputAllOf urbanization(String urbanization) {
  ...
  **/
  ...
  public RecipientInputAllOf city(String city) {
  ...
  **/
  ...
  public RecipientInputAllOf state(String state) {
  ...
  **/
  ...
  public RecipientInputAllOf zipCode(Object zipCode) {
  ...
  **/
   ...
   * @return the RecipientInputAllOf instance itself
   */
  public RecipientInputAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecipientInputAllOf recipientInputAllOf = (RecipientInputAllOf) o;
    return Objects.equals(this.recipient, recipientInputAllOf.recipient) &&
        Objects.equals(this.primaryLine, recipientInputAllOf.primaryLine) &&
        Objects.equals(this.secondaryLine, recipientInputAllOf.secondaryLine) &&
        Objects.equals(this.urbanization, recipientInputAllOf.urbanization) &&
        Objects.equals(this.city, recipientInputAllOf.city) &&
        Objects.equals(this.state, recipientInputAllOf.state) &&
        Objects.equals(this.zipCode, recipientInputAllOf.zipCode)&&
        Objects.equals(this.additionalProperties, recipientInputAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientInputAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecipientInputAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecipientInputAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecipientInputAllOf is not found in the empty JSON string", RecipientInputAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecipientInputAllOf.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("recipient").isJsonNull() && !jsonObj.get("recipient").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecipientInputAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecipientInputAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecipientInputAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecipientInputAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<RecipientInputAllOf>() {
           @Override
           public void write(JsonWriter out, RecipientInputAllOf value) throws IOException {
           ...
           @Override
           public RecipientInputAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecipientInputAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecipientInputAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecipientInputAllOf
  * @throws IOException if the JSON string is invalid with respect to RecipientInputAllOf
  */
  public static RecipientInputAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecipientInputAllOf.class);
  }

 /**
  * Convert an instance of RecipientInputAllOf to an JSON string
  *
  * @return JSON string
  */
