...
public class Campaign {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dateCreated, dateModified, deleted, _object, description, billingGroupId, name, scheduleType, targetDeliveryDate, sendDate, cancelWindowCampaignMinutes, metadata, useType, autoCancelIfNcoa, id, isDraft, creatives, uploads, additionalProperties);
  }
